...
public class ListTopRatedMoviesPresenterTest extends AndroidTestCase {
    ...
    public void testLoadMovies_AnyMovie() throws Exception {
        ...
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocationOnMock) throws Throwable {
                ...
                }).when(movieApi).listTopRatedMovies(page);
                return null;
            }
