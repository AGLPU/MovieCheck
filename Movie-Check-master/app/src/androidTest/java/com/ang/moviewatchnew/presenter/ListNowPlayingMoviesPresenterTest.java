...
import com.ang.moviewatchnew.entity.MovieBuilder;
...
public class ListNowPlayingMoviesPresenterTest extends AndroidTestCase {
    ...
    public void testLoadMovies_AnyMovie() throws Exception {
        ...
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocationOnMock) throws Throwable {
                ...
                }).when(movieApi).listNowPlayingMovies(page);
                return null;
            }
